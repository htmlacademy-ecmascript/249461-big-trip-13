...
/* harmony import */ var _view_edit_form_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./view/edit-form.js */ "./src/view/edit-form.js");
...
// Маршрут и стоимость
render(tripMain, Object(_view_trip_info_js__WEBPACK_IMPORTED_MODULE_0__["tripInfo"])(), 'afterbegin');
const tripInfoSection = pageBody.querySelector('.trip-info');
render(tripInfoSection, Object(_view_trip_cost_js__WEBPACK_IMPORTED_MODULE_1__["tripCost"])(), 'beforeend');
...
for (let i = 0; i < POINT_COUNT; i++) {
    render(pointEventsList, Object(_view_trip_item_js__WEBPACK_IMPORTED_MODULE_5__["pointItem"])(), 'beforeend');
}

render(pointEventsList, Object(_view_edit_form_js__WEBPACK_IMPORTED_MODULE_6__["editForm"])(), 'afterbegin');
render(pointEventsList, Object(_view_create_form_js__WEBPACK_IMPORTED_MODULE_7__["createForm"])(), 'afterbegin');
